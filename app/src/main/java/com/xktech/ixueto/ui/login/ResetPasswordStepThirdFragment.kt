...
import com.xktech.ixueto.databinding.FragmentResetPasswordStepThirdBinding
...
@AndroidEntryPoint
class ResetPasswordStepThirdFragment : Fragment() {
    private var binding: FragmentResetPasswordStepThirdBinding? = null
    ...
    private var resetPwdToken: String? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        resetPwdToken =
            arguments?.getString("resetPwdToken")
    ...
    private fun submitData() {
        val newPassword = newPassword.editText?.text.toString().trim()
        userViewModel.resetPassword(resetPwdToken.toString(), newPassword)
    ...
    private fun initView() {
        binding = FragmentResetPasswordStepThirdBinding.inflate(layoutInflater)
    ...
    private fun changeSubmitStateByFormVerify() {
        submitButton.isEnabled = formVerify()
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            ResetPasswordStepThirdFragment()
    }
}