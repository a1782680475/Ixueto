...
public class FaceDetectRoundView extends View {
    ...
    public static int COLOR_BG = Color.parseColor("#FFFFFF");
    public static int COLOR_TIPS = Color.parseColor("#000000");
    public static int COLOR_SECOND_TIPS = Color.parseColor("#666666");
    ...
    public FaceDetectRoundView(Context context, AttributeSet attrs) {
        ...
        if (isDark) {
            COLOR_BG = context.getResources().getColor(R.color.md_theme_dark_background);
            COLOR_TIPS = context.getResources().getColor(R.color.md_theme_dark_onSurface);
            COLOR_SECOND_TIPS =  context.getResources().getColor(R.color.md_theme_dark_onSurfaceVariant);
        }else{
            COLOR_BG = context.getResources().getColor(R.color.md_theme_light_background);
            COLOR_TIPS = context.getResources().getColor(R.color.md_theme_light_onSurface);
            COLOR_SECOND_TIPS = Color.parseColor("#666666");
        }
        ...
        mTextSecondPaint.setColor(COLOR_SECOND_TIPS);
        ...
        mTextTopPaint.setColor(COLOR_TIPS);
